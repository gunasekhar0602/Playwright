...
test.only("Infinite Scrolling", async({page})=>
{
    ...
    // We need to compare the current previousHeight and currentHeight
    ...
    while(true)
    {
        ...
        // evaluate will take an arrow function as Parameter
        ...
        // else assign previous height = current height
